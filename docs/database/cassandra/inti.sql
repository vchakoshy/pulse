CREATE KEYSPACE telegram WITH replication = {'class': 'SimpleStrategy', 'replication_factor': '1'}  AND durable_writes = true;
...
CREATE TABLE telegram.blocked_contacts (
    user_id int,
    phone text,
    PRIMARY KEY (user_id, phone)
) WITH CLUSTERING ORDER BY (phone ASC)
...
) WITH CLUSTERING ORDER BY (dialog_id ASC)
    AND bloom_filter_fp_chance = 0.01
    AND caching = {'keys': 'ALL', 'rows_per_partition': 'NONE'}
    AND comment = ''
    AND compaction = {'class': 'org.apache.cassandra.db.compaction.SizeTieredCompactionStrategy', 'max_threshold': '32', 'min_threshold': '4'}
...
CREATE TABLE telegram.secret_chats (
    chat_id int PRIMARY KEY,
    admin_id int,
    participant_id int
) WITH bloom_filter_fp_chance = 0.01
...
CREATE TABLE telegram.server_salts (
    auth_key_id bigint,
    valid_since timestamp,
    server_salt bigint,
    PRIMARY KEY (auth_key_id, valid_since)
) WITH CLUSTERING ORDER BY (valid_since ASC)
    AND bloom_filter_fp_chance = 0.01
    AND caching = {'keys': 'ALL', 'rows_per_partition': 'NONE'}
    AND comment = ''
    AND compaction = {'class': 'org.apache.cassandra.db.compaction.SizeTieredCompactionStrategy', 'max_threshold': '32', 'min_threshold': '4'}
...
CREATE TABLE telegram.chat_messages (
    to_chat_id int PRIMARY KEY,
    date int,
    entities blob,
    fwd_date int,
    fwd_from_id int,
...
CREATE TABLE telegram.auth_keys (
...
CREATE TABLE telegram.chat_users (
    chat_id int PRIMARY KEY,
    user_id int
) WITH bloom_filter_fp_chance = 0.01
    AND caching = {'keys': 'ALL', 'rows_per_partition': 'NONE'}
...
CREATE MATERIALIZED VIEW telegram.user_chats AS
    SELECT *
    FROM telegram.chat_users
...
CREATE TABLE telegram.outgoing_messages (
    user_id int,
    to_user_id int,
    message_id int,
    date int,
...
) WITH CLUSTERING ORDER BY (to_user_id ASC, message_id ASC)
    AND bloom_filter_fp_chance = 0.01
    AND caching = {'keys': 'ALL', 'rows_per_partition': 'NONE'}
    AND comment = ''
    AND compaction = {'class': 'org.apache.cassandra.db.compaction.SizeTieredCompactionStrategy', 'max_threshold': '32', 'min_threshold': '4'}
...
CREATE MATERIALIZED VIEW telegram.outgoing_messages_by_chat AS
    SELECT *
    FROM telegram.outgoing_messages
    ...
    WITH CLUSTERING ORDER BY (to_chat_id ASC, to_user_id ASC, message_id ASC)
    AND bloom_filter_fp_chance = 0.01
    AND caching = {'keys': 'ALL', 'rows_per_partition': 'NONE'}
    AND comment = ''
    AND compaction = {'class': 'org.apache.cassandra.db.compaction.SizeTieredCompactionStrategy', 'max_threshold': '32', 'min_threshold': '4'}
...
CREATE TABLE telegram.incoming_messages (
    user_id int,
    from_user_id int,
    message_id int,
    date int,
...
) WITH CLUSTERING ORDER BY (from_user_id ASC, message_id ASC)
    AND bloom_filter_fp_chance = 0.01
    AND caching = {'keys': 'ALL', 'rows_per_partition': 'NONE'}
    AND comment = ''
    AND compaction = {'class': 'org.apache.cassandra.db.compaction.SizeTieredCompactionStrategy', 'max_threshold': '32', 'min_threshold': '4'}
...
CREATE MATERIALIZED VIEW telegram.incoming_messages_by_chat AS
    SELECT *
    FROM telegram.incoming_messages
    ...
    WITH CLUSTERING ORDER BY (to_chat_id ASC, from_user_id ASC, message_id ASC)
    AND bloom_filter_fp_chance = 0.01
    AND caching = {'keys': 'ALL', 'rows_per_partition': 'NONE'}
    AND comment = ''
    AND compaction = {'class': 'org.apache.cassandra.db.compaction.SizeTieredCompactionStrategy', 'max_threshold': '32', 'min_threshold': '4'}
...
CREATE TABLE telegram.profile_photos (
    user_id int PRIMARY KEY,
    caption text,
    crop_left double,
    crop_top double,
...
CREATE TABLE telegram.session_queue (
    session_id bigint,
    message_id bigint,
